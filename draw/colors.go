...
var TrubetskoyPalette = color.Palette{
	...
	color.RGBA{0x3c, 0xb4, 0x4b, 0xff}, /* green */
	color.RGBA{0xff, 0xe1, 0x19, 0xff}, /* yellow */
	color.RGBA{0x00, 0x82, 0xc8, 0xff}, /* blue */
	color.RGBA{0xf5, 0x82, 0x31, 0xff}, /* orange */
	color.RGBA{0x91, 0x1e, 0xb4, 0xff}, /* purple */
	color.RGBA{0x46, 0xf0, 0xf0, 0xff}, /* cyan */
	color.RGBA{0xf0, 0x32, 0xe6, 0xff}, /* magenta */
	color.RGBA{0xd2, 0xf5, 0x3c, 0xff}, /* lime */
	color.RGBA{0xfa, 0xbe, 0xbe, 0xff}, /* pink */
	color.RGBA{0x00, 0x80, 0x80, 0xff}, /* teal */
	color.RGBA{0xe6, 0xbe, 0xbe, 0xff}, /* lavender */
	color.RGBA{0xaa, 0x6e, 0x28, 0xff}, /* brown */
	color.RGBA{0xff, 0xfa, 0xc8, 0xff}, /* beige */
	color.RGBA{0x80, 0x00, 0x00, 0xff}, /* maroon */
	color.RGBA{0xaa, 0xff, 0xcf, 0xff}, /* mint */
	color.RGBA{0x80, 0x80, 0x00, 0xff}, /* olive */
	color.RGBA{0xff, 0xd8, 0xb1, 0xff}, /* coral */
